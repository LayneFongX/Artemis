package com.farid.artemis.bean;
...
//@Configuration
public class I18nDBMessageSource extends AbstractMessageSource implements ResourceLoaderAware {
    ...
    public void setResourceLoader(ResourceLoader resourceLoader) {
        this.resourceLoader = (Objects.isNull(resourceLoader) ? new DefaultResourceLoader() : resourceLoader);
    }
